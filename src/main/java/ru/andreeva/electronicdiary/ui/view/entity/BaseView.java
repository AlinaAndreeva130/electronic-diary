...
import ru.andreeva.electronicdiary.service.specification.SpecificationFactory;
import ru.andreeva.electronicdiary.ui.component.BaseEditor;
import ru.andreeva.electronicdiary.ui.filter.GridFilterService;
...
public abstract class BaseView<T, ID, I extends JpaSpecificationExecutor<T> & JpaRepository<T, ID>> extends LitTemplate {
    ...
    public BaseView(I repository, SpecificationFactory<T> specificationFactory, BaseEditor<T> editor) {
    ...
    private void addEntity(ClickEvent<Button> event) {
        editor.add(filterService::refresh);
    }
